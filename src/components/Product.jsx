...
function Product() {
    return (
      <div className="container">
        <nav>
          <img src="/images/logo.svg" alt="CRAPPO" />
        ...
        <section className="why">
          ...
          <div className="why-flex">
            ...
            <img className='why-effect-1' src="/images/why-model-1.png" alt="abs-logo" />
            <img className='why-effect-2' src="/images/why-model-2.png" alt="abs-logo" />
            <img className='why-effect-3' src="/images/why-ribbon.png" alt="abs-logo" />
        </section>
          ...
          <div className="earn-flex-1">
                ...
                <div className='abs'>
                    <div className='abs-flex-row'>
                        ...
                        <div className='abs-flex-2'>
                            <div className='abs-flex-3'>
                                <p>TH/s</p>
                                <img src="/images/Arrow-down.png" alt="arrow-logo" />
                            </div>
                            <hr />
                        </div>
                    ...
                    <div className='abs-flex-col'>
                        ...
                        <p className='abs-flex-col-txt-2'>0.055 130 59 ETH <span className='span-txt'>($1275)</span></p>
